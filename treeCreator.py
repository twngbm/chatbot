...
Public = {Checklist: {"請先至行政院提供免費無線上網iTaiwan服務首頁申請帳號，並於開放地點選取網路基地臺名稱NCKU-iTaiwan登入使用。因臺灣學術網路與iTaiwan無線網路雙向漫遊將於109年7月1日起停止服務，NCKU-iTaiwan亦於109年7月1日起停止服務。": None}}
WAN = {"UserDomain": {
    "本校師生": NckuWAN,
    "他校師生": NoneNckuWAN,
    "本校校友": Alumni,
...
iNCKUDefaultPassFail = {Checklist: {Call61010: None}}
iNCKU = {"inckuQD": {
...
staff_mail_pisa = {"mail_qd": {
    ...
    "忘記帳號": {Checklist: {"請致電#61010為您服務。": None}},
...
staff_mail_z = {"mail_qd": {
    ...
    "帳號申請": {Checklist: {"帳號即為\"z+您的員工識別證號\"，舉例:若您的員工識別證號為10745678，則您的公務信箱帳號即為z10745678": None}},
...
root = {
    "Keyword": {
        ...
        "成功入口": iNCKU,
        "電子信箱": Mail,
        "防疫系統": {Checklist: {"請直撥分機50340衛保組": None}}
